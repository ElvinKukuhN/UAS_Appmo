...
public class Detail3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        second_back_arrow.setOnClickListener(view -> {
            Intent detail = new Intent(Detail3.this, MainActivity.class);
...
/*
        second_arrow_up.setOnClickListener(view -> {
            Intent intent = new Intent(Detail2.this, swipeUp.class);

            Pair[] pairs = new Pair[1];
            pairs[0] = new  Pair<View, String>(second_arrow_up, "background_image_transition");

            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Detail2.this, pairs);
